...
const paths = {
  ...
  tools: <><path d="m14.7 6.3 3-3a4.2 4.2 0 0 1-5.4 5.4l-6.6 6.6a2.1 2.1 0 0 0 3 3l6.6-6.6a4.2 4.2 0 0 0 5.4-5.4l-3 3Z"/><path d="m5 4 3 3M3 6l3-3m9 12 5 5m-3-7 4 4"/></>,
