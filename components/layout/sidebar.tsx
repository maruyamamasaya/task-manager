...
// here so restoring them only requires updating this temporary visibility list.
const hiddenPaths = new Set(["/dashboard", "/analytics"]);
const items = allItems.filter(([, href]) => !hiddenPaths.has(href));
