...
const groups: { label: string; items: [string, string, IconName][] }[] = [
  { label: "ワークスペース", items: [["Today", "/today", "today"], ["タスク", "/tasks", "tasks"], ["スケジュール", "/schedule", "schedule"], ["プロジェクト", "/projects", "projects"]] },
