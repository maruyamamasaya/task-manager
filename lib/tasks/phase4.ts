...
export function needsReflection(task: Pick<Task,"status"|"reflection_skipped">, reflection?: Reflection | null) { return task.status === "done" && !task.reflection_skipped && !reflection; }
