...
export interface WbsProjectSummary extends WbsProject { role:WbsProjectRole; itemCount:number; progress:number; overdueCount:number; inProgressCount:number; onHoldCount:number; }
